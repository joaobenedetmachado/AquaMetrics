...
#define TEMPERATURE_PIN 15  // Pino de entrada para o sensor de temperatura
...
const int sensorPinTDS = 33;  // Pino do sensor TDS
...
void loop() {
  ...
  float tensao = valorAnalogico * (3.3 / 1024.0);
